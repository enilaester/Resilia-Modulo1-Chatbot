...
def validaCPF (cpf): #Função que lê o tanto de caracteres digitados e limita-se a aceitar apenas 11 em um laço
...
cpf = input(f'Obrigado, {nome}! Por favor, digite agora o seu CPF (sem pontos ou traços): ')
cpf = validaCPF(cpf)
email = input('Excelente! E qual o seu melhor e-mail? ')

# --------------------------------- MENU INICIAL------------------------------

while condicao1: #Laço de repetição, onde se a variável for diferente de Falso fica em loop
    ...
    print(f'\nEstamos prontos para cuidar do seu pet, {nome}!') #Utiliza o f, para apresentar uma variável no print
    print('\n1 - Para acessar a emergência') #Utiliza o \n para pular uma linha da anterior, para organização do código
...
# ---------------------------------------EXAMES----------------------------------------------
        ...
        while condicao2:
            ...
            if menu2 == 1:
                ...
                print('\Atendimento finalizado, é sempre um prazer receber nossos aumigos e gatoamigos!')
                condicao1 = False
                condicao2 = False 
            else:
                print('\nEssa não é uma opção válida. Por favor tente novamente.')
...
# ---------------------------------------FINANCEIRO----------------------------------------------
        ...
        while condicao2:
            ...
            if menu2 == 1:
                ...
                print('Por favor, ligue para (11) 3572-9854 e entenda melhor todos os benefícios oferecidos em cada plano!')
                retornarOuSair()
            elif menu2 == 2:
                ...
                print('\nDatas disponíveis: 5, 10, 15, 20, 25. \nPor favor, ligue para: (11) 3572-9854 e confirme a alteração. Estamos disponíveis de segunda à sexta-feira das 8:00 às 18:00.')  
                retornarOuSair()
            elif menu2 == 4:
                print('\nVocê será redirecionado ao nosso menu')
                condicao2 = False
...
# ----------------------------------- CONTATOS -------------------------------------------------
        ...
        while condicao2:
            ...
            if menu2 == 1:
                ...
                print('Telefone: (11) 3572-9856\nWhatsapp: (11) 91135 - 9858\nE-mail: contato@santuariodosanimais.com')
                retornarOuSair()
            elif menu2 == 2:
                print('\nVocê pode nos encontrar em:')
                print('Rua das Laranjeiras, 123 - Alto da Lapa - Zona Oeste - São Paulo/SP')
                ...
                print('https://bit.ly/3NWa7L') #Link de um direcionador para o chat com a atendente com um encurtador do link
                retornarOuSair()
            elif menu2 == 5:                
                print('\nVocê será redirecionado ao nosso menu')
                condicao2 = False
